...
setproctitle.setproctitle("train_driveseg_msc_rmi_stdc_zerorains")
...
def parse_args():
    ...
    parse.add_argument(
        ...
        dest='respath',
        type=str,
        default="checkpoints/driveseg_MSC_RMI_optim_STDC2-Seg/",
    )
    # 主干网络
    parse.add_argument(
        '--backbone',
...
def train():
    ...
    # net.load_state_dict(torch.load("/home/disk2/ray/workspace/zerorains/stdc/STDC2optim_cityscapes_msc.pth"))
    ...
    tensor_board_path = os.path.join("./logs", "driveseg_msc" + '{}'.format(time.strftime('%Y-%m-%d-%H-%M-%S')))
