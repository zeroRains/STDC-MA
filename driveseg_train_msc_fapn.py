...
def parse_args():
    ...
    parse.add_argument(
        ...
        dest='respath',
        type=str,
        default="checkpoints/driveseg_MSC_FaPN_RMI_optim_STDC2-Seg/",
    )
    # 主干网络
    parse.add_argument(
        '--backbone',
...
def train():
    ...
    net.load_state_dict(torch.load(
        '/home/disk2/ray/workspace/zerorains/stdc/checkpoints/driveseg_MSC_FaPN_RMI_optim_STDC2-Seg/pths/model_maxmIOU75.pth'))
    ...
    tensor_board_path = os.path.join("./logs", "driveseg_msc_fapn" + '{}'.format(time.strftime('%Y-%m-%d-%H-%M-%S')))
