...
if __name__ == "__main__":
    ...
    # # 0.725695013999939
    # evaluatev0('./checkpoints/train_STDC2-Seg/pths/model_final.pth', dspth='./data', backbone='STDCNet1446',
    #            scale=0.75,
    ...
    #            use_boundary_2=False, use_boundary_4=False, use_boundary_8=True, use_boundary_16=False)
    # # 0.725695013999939
    # evaluatev0('./checkpoints/train_STDC2-Seg/pths/model_maxmIOU75.pth', dspth='./data', backbone='STDCNet1446',
    #            scale=0.75,
    #            use_boundary_2=False, use_boundary_4=False, use_boundary_8=True, use_boundary_16=False)
    #
    # evaluatev0('./checkpoints/train_STDC2-Seg/pths/model_maxmIOU75.pth', dspth='./data', backbone='STDCNet1446',
    ...
    #            use_boundary_2=False, use_boundary_4=False, use_boundary_8=True, use_boundary_16=False)
    #
    # evaluatev0('./checkpoints/train_STDC2-Seg/pths/model_maxmIOU50.pth', dspth='./data', backbone='STDCNet1446',
    #            scale=0.75,
    #            use_boundary_2=False, use_boundary_4=False, use_boundary_8=True, use_boundary_16=False)
    #
    # evaluatev0('./checkpoints/train_STDC2-Seg/pths/model_maxmIOU50.pth', dspth='./data', backbone='STDCNet1446',
