...
setproctitle.setproctitle("train_gald_stdc_zerorains")
...
def parse_args():
    ...
    parse.add_argument(
        ...
        dest='respath',
        type=str,
        default="checkpoints/GALD_optim_STDC2-Seg/",
    )
    # 主干网络
    parse.add_argument(
        '--backbone',
...
def train():
    ...
    net = torch.load("./checkpoints/GALD_optim_STDC2-Seg/pths/model_maxmIOU50.pth")
    # print(net)
    # exit(0)
    net.cuda(CUDA_ID)
    net.train()
