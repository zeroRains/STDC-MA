...
from models.model_stages_la import BiSeNet
...
setproctitle.setproctitle("train_la_stdc_zerorains")
...
def parse_args():
    ...
    parse.add_argument(
        ...
        dest='respath',
        type=str,
        default="checkpoints/La_optim_STDC2-Seg/",
    )
    # 主干网络
    parse.add_argument(
        '--backbone',
...
def train():
    ...
    # net = torch.load("./checkpoints/La_optim_STDC2-Seg/pths/model_maxmIOU50.pth")
    net = torch.load("./STDC2optimLA.pth")
    # print(net)
    # exit(0)
    net.cuda(CUDA_ID)
    net.train()
    ...
    tensor_board_path = os.path.join(tensor_board_log, '{}'.format(time.strftime('%Y-%m-%d-%H-%M-%S')))
