...
setproctitle.setproctitle("train_msc_rmi_stdc_zerorains")
...
def parse_args():
    ...
    parse.add_argument(
        ...
        dest='respath',
        type=str,
        default="checkpoints/ctyiscapes_MSC_RMI_optim_STDC2-Seg/",
    )
    # 主干网络
    parse.add_argument(
        '--backbone',
...
def train():
    ...
    tensor_board_path = os.path.join("./logs", "cityscapes_msc" + '{}'.format(time.strftime('%Y-%m-%d-%H-%M-%S')))
